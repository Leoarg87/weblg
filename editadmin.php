...
<body>
<form class="container-table-1"action="procesaradmin.php" method="post" >
...
foreach($arr as $row){
   ?>
<input type="hidden"name="id" REQUIRED class="table__item text-center" value="<?php echo $row["id"];?>">
<input type="text" name="nombre" REQUIRED class="table__item text-center" value="<?php echo $row["nombre"];?>">
<input type="text" name="rol" REQUIRED class="table__item text-center" value="<?php echo $row["role"];?>">
<input type="text" name="user"REQUIRED class="table__item text-center" value="<?php echo $row["user"];?>">
<input type="date" REQUIRED class="table__input text-center" name="dia" id="dia" required min=<?php $hoy=date("Y-m-d",); echo $hoy;?> />  
  <select type="time" REQUIRED name="hora" class="table__input text-center" >
...
<input type="text" name="asunto" REQUIRED class="table__input text-center">
<button type="submit" name="procesaradmin"class="boton_submit" action="procesaradmin.php">Modificar</button>
