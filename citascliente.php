...
<div class="container-table" >
  ...
  <a href="modificarcita.php?id=<?php echo $row["id"];?>"class="table__item__link">Modificar</a> |
  <a href="eliminarcita.php?id=<?php echo $row["id"];?>" class="table__item__link">Eliminar</a></div>

  </div>
  </div>

  <div class="col text-center">
  <a href="miperfil.php" class="btn btn-primary regular-button text-white" role="button">Regresar a mi perfil </a>
  </div>	
